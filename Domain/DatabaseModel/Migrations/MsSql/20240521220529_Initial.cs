        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StreetAddress2 = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Customers_Orders", x => new { x.CustomerId, x.OrderId });
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Customers_Orders_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Categories_Products", x => new { x.CategoryId, x.ProductId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Product_ProductImage", x => new { x.ProductId, x.ProductImageId });
                    table.ForeignKey(
                        name: "FK_Product_ProductImage_ProductImages_ProductImageId",
                        column: x => x.ProductImageId,
                        principalTable: "ProductImages",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Product_ProductImage_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                name: "Customers_CustomerAddress",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_Customers_CustomerAddress", x => new { x.CustomerAddressId, x.CustomerId });
                    table.ForeignKey(
                        name: "FK_Customers_CustomerAddress_CustomerAddresses_CustomerAddressId",
                        column: x => x.CustomerAddressId,
                        principalTable: "CustomerAddresses",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Customers_CustomerAddress_Customers_CustomerId",
                        column: x => x.CustomerId,
                        principalTable: "Customers",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_CustomerAddress_CustomerId",
                table: "Customers_CustomerAddress",
                column: "CustomerId");

            migrationBuilder.CreateIndex(
                name: "IX_Customers_Orders_OrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Product_ProductImage_ProductImageId",
                table: "Product_ProductImage",
